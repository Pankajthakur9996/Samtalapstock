        ...
        <Container className=' d-flex justify-content-center align-items-center   py-4' style={{height:"100%"}}>
            ...
            height="40" className="d-inline-block align-top" style={{ border:"1px solid black", borderRadius:"20px"}} />
                ...
                <Form onSubmit={formik.handleSubmit}>
                    <Form.Group controlId='first' className='mb-4 d-flex '> 
                    ...
                    <Form.Group controlId='lastName' className='mb-4 d-flex'> 
                    ...
                    <Form.Group controlId='password' className='mb-4 d-flex'> 
                    ...
                    <Form.Group controlId='confirm' className='mb-4 d-flex'> 
